...
4. **General Functionalities**:
   ...
   - **Filter/Search**:
     - Search donation sites based on specific criteria such as blood type and date of the event.
   - **Authentication**:
     - User signup/login/
...
4. **Limited Analytics**:
   - No comprehensive analytics or dashboards for tracking historical trends in donations or user participation.
